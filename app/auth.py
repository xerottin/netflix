...
async def create_user(db: db_dependency, create_user_request: UserCreate):
    ...
    return UserResponse(user_id=create_user_model.id, username=create_user_model.username)
...
def create_access_token(username: str, id: int, expires_delta: Union[timedelta, None] = None) -> str:
